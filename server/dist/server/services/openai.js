...
import { MACHINE_SPIRIT_CONFIG, OPENAI_CLIENT_CONFIG, OPENAI_RESPONSE_CONFIG, } from '../config/openai.conf.js';
import { buildMachineSpiritContext } from './machine-spirit-context.js';
const client = new OpenAI(OPENAI_CLIENT_CONFIG);
export async function askMachineSpirit(query) {
